...
\newcommand{\inred}[1]{{\color{black}#1}} % neutralize revision highlights
...
% \inred{with horizontal asymptote at $f_{2}=1/(1/(p_1+D)+1/q_2)$ and vertical asymptote at $f_{1}=1/(1/p_1+1/(D+q_2))$.}
